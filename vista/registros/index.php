  ...
  <section id="container" class="">
	    ...
	    <section id="main-content">
	      <section class="wrapper">
	        ...
	        <div class="row">
	          <div class="col-lg-12">
	            <h3 class="page-header"><i class="fa fa-laptop"></i>Registros</h3>
	            <ol class="breadcrumb">
	              <li><i class="fa fa-home"></i><a href="index.html">Inicio</a></li>
	              <li><i class="fa fa-laptop"></i>Registros</li>
	            </ol>
	          </div>
	        </div>
	            ...
	            <table class="table table-striped table-bordered table-hover " id="editable" >
		            ...
		            <tr>
		               ...
		               <th><i class="icon_profile"></i>Nombre completo</th>
	                    ...
	                    <th><i class="icon_mail_alt"></i>Cuidad</th>
	                    <th width="10%"><i class="icon_mobile"></i>E-mail</th>
	                    <th><i class="icon_mobile"></i>Programa</th>
	                    <th><i class="icon_mobile"></i>Carrera</th>
	                    <th><i class="icon_cogs"></i> Mensaje</th>
						...
						if($db->numRows($result) > 0){
						  while ($r = $db->datos($result)) {
						    ...
						    echo "<td>" . $r['Mensaje'] . "</td>";
						          ...
						          echo "<td>
						                  <center>
						                   <a href=\"#\" onclick=\"javascript:cargarDatos('".$r['Documento_padre']."');\" style=\"margin-bottom:-3px;\" class=\"btn btn-primary btn-md btn-xs\" title=\"Editar\">Registrar</a>&nbsp;
